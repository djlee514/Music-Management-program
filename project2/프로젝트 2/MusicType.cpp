...
void MusicType::SetRecord(int inid, string inname, string inistitle, string insinger, string inrunningtime, string ingenre, string inalbumname, string inrelease,
